...
from utils.Utils import encode_int_to_bytes, decode_str_from_bytes, encode_str_to_bytes, \
    decode_int_to_bytes
...
class Packet:
    ...
    def encode(self):
        encoded_seq = encode_int_to_bytes(self.seq, SEQ_SIZE)
        encoded_crc = encode_int_to_bytes(self.crc, CRC_SIZE)
    ...
    def decode(self, data):
        ...
        self.seq = decode_int_to_bytes(seq_header)
        self.crc = decode_int_to_bytes(crc_header)
